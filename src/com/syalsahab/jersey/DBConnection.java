...
public class DBConnection {
     ...
     * DBConnection class performs DB related operations like
     *  Opening DB connection, Inserting records and Selecting records from Table
     * @return
     * @throws Exception
     */
	...
	public static boolean insertUser(String uname,String pwd)throws SQLException, Exception{
		...
		try{
			...
			Statement stmt = dbConn.createStatement();
			String query = "INSERT INTO user(name,username,password) values('"+ uname+"',"+"'"
			+uname+"','"+pwd+"')"; 
